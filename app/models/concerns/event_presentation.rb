...
module EventPresentation
  ...
  def timelens_present?
    timeline_filename.present? && thumbnails_filename.present?
  end
  ...
  # Prefers files with multiple audio tracks (html5=0).
  ...
  # Returns list of videos, one per quality/resolution.
  # Prefers files with multiple audio tracks (html5=0).
