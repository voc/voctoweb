json.extract! event, :guid, :id, :title, :subtitle, :slug, :link, :description, :original_language, :persons, :tags, :view_count, :promoted, :metadata, :date, :release_date, :updated_at
