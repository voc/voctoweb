module Types
  class AssetType < Types::BaseObject
    ...
    field :duration, Int, "The recordings's duration in seconds", null: false
    field :mimeType, String, "The recordings's mime type, e.g. video/mp4", null: false
    field :width, Int, "The width of this recording in px, if it is a video", null: false
    field :height, Int, "The height of this recording in px, if it is a video", null: false
    field :highQuality, Boolean, "Whether this recording is a video with at least 720p resolution", null: false
    field :size, Int, description: "The recording's approximate size in megabytes", null: false
    field :updatedAt, GraphQL::Types::ISO8601DateTime, "Identifies the date and time when the object was last updated", null: false
