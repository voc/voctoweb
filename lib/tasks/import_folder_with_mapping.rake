namespace :media do
  desc 'import recordings from one folder to existing events. Each line of the input-file should contain a slug-prefix for finding the event and a filename'
  task :import_folder_with_mapping => :environment do |_t, _args|
    @list = ENV['list']
