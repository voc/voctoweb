...
1. In Authentik, create an **OAuth2/OpenID Provider** (confidential client) with redirect URI `https://<your-voctoweb-host>/admin/auth/authentik/callback` and scopes `openid email profile`.
...
3. Set the following environment variables for the voctoweb process:
       ...
       AUTHENTIK_REDIRECT_URI=https://<your-voctoweb-host>/admin/auth/authentik/callback
